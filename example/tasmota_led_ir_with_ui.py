...
index_page.add_item(Slider("Rot", color='red').connect(color.field('red'), convert=True))  # type: ignore
index_page.add_item(Slider("Grün", color='green').connect(color.field('green'), convert=True))  # type: ignore
index_page.add_item(Slider("Blau", color='blue').connect(color.field('blue'), convert=True))  # type: ignore
