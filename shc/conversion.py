...
register_converter(datatypes.RangeFloat1, datatypes.RangeInt0To100, lambda v: round(v * 100))
register_converter(datatypes.RangeUInt8, datatypes.RangeInt0To100, lambda v: round(v * 100 / 255))
register_converter(datatypes.RangeUInt8, datatypes.RangeFloat1, lambda v: v / 255)
register_converter(datatypes.RangeInt0To100, datatypes.RangeFloat1, lambda v: v / 100)
...
register_converter(bool, datatypes.RangeUInt8, lambda v: 255 if v else 0)
register_converter(bool, datatypes.RangeFloat1, lambda v: 1.0 if v else 0.0)
register_converter(bool, datatypes.RangeInt0To100, lambda v: 100 if v else 0)
